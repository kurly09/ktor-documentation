...
2. Use `call.respond` to send scraping data to Prometheus.
   ...
   You can find the full example here: [micrometer-metrics](https://github.com/ktorio/ktor-documentation/tree/%branch-name%/codeSnippets/snippets/micrometer-metrics).
