...
<p>
Code examples: 
<a href="https://github.com/ktorio/ktor-documentation/tree/%branch-name%/codeSnippets/snippets/cors-backend">cors-backend</a>, 
<a href="https://github.com/ktorio/ktor-documentation/tree/%branch-name%/codeSnippets/snippets/cors-frontend">cors-frontend</a>
</p>
</microformat>
...
You can find the full example here: [cors-backend](https://github.com/ktorio/ktor-documentation/tree/%branch-name%/codeSnippets/snippets/cors-backend).
